...
def mapper(record):
 ...
 #         print "is 4straight"
 #         print straightrunfaces[i],straightrunfaces[i+1],straightrunfaces[i+2],straightrunfaces[i+3],straightrunfaces[i+4]
 #         print counts[straightrunfaces[i]],counts[straightrunfaces[i+1]],counts[straightrunfaces[i+2]],counts[straightrunfaces[i+3]],counts[straightrunfaces[i+4]]
 #         print counts[straightrunfaces[i+4]]
 #         print cards
          is_4straight = True 
 #         raw_input("press enter to continue")
          break

    if (counts[straightrunfaces[10]] and
		counts[straightrunfaces[11]] and
        counts[straightrunfaces[12]] and
		counts[straightrunfaces[13]]):
#        print "isalso 4straight"
#        print straightrunfaces[i],straightrunfaces[i+1],straightrunfaces[i+2],straightrunfaces[i+3],straightrunfaces[i+4]
#        print counts[straightrunfaces[i]],counts[straightrunfaces[i+1]],counts[straightrunfaces[i+2]],counts[straightrunfaces[i+3]],counts[straightrunfaces[i+4]]
#        print counts[straightrunfaces[i+4]]
#        print cards
